...
If you want a seamless install, you need to put Redis and the client in their respective folders, otherwise the .bat files won't work, and the server won't find the client resources.
